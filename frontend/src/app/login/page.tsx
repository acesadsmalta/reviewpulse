...
import { Lock, Mail, Star, AlertCircle, ArrowLeft, Loader2 } from 'lucide-react';
    ...
    <main className="min-h-screen flex font-sans antialiased text-foreground bg-background">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-slate-950 text-white flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="relative z-10 space-y-6 max-w-lg text-white">
          <div className="inline-flex items-center gap-1 bg-[#FBBF24]/20 text-[#FBBF24] border border-[#FBBF24]/30 px-3 py-1 rounded-full text-sm font-bold tracking-wider uppercase">
            <Star className="h-4 w-4 fill-current" /> Business Portal
          </div>
          <h2 className="text-4xl font-extrabold tracking-tight leading-tight" style={{ color: '#ffffff' }}>
            Manage Reviews, Campaigns & Rewards
          </h2>
          <p className="text-lg" style={{ color: '#e2e8f0' }}>
            Sign in to access your administrative dashboard, view captured customer contacts, configure GMB routing rules, and design printable QR cards.
          </p>
        </div>
        ...
        <div className="w-full max-w-md space-y-8">
          <div className="space-y-3">
            ...
            <p className="text-sm font-medium text-slate-500">
              Welcome back! Enter your portal credentials to log in.
            </p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  type="email"
                  required
                  placeholder="admin@reviewpulse.com"
                  value={email}
          ...
          <div className="text-center pt-2">
            <p className="text-sm font-medium text-slate-500">
              New to Review Pulse?{' '}
              <Link href="/signup" className="font-bold text-blue-600 hover:text-blue-800 hover:underline">
